...
export default function MyDocumentsPage() {
  ...
  const hasActiveFilters = activeFilterCount > 0; // ← THIS WAS MISSING
  ...
  // Count active filters - THIS IS NOW DEFINED ABOVE AS activeFilterCount
  // const activeFilterCount = Object.values(filters).reduce((count, filterArray) => 
  //   count + filterArray.length, 0
  // );

  // THIS IS NOW DEFINED ABOVE AS hasActiveFilters
            ...
            <CardContent className="p-6">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  <Popover open={showFilters} onOpenChange={setShowFilters}>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {hasActiveFilters && ( // ← THIS NOW WORKS
                  ...
                  {(searchTerm || hasActiveFilters) && ( // ← THIS NOW WORKS
                    <Button 
                      variant="outline" 
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 text-xl font-medium mb-3">
                  {searchTerm || hasActiveFilters ? 'No documents match your search' : 'No documents created yet'} {/* ← THIS NOW WORKS */}
                </p>
